# Generated by Django 3.0.4 on 2023-04-26 21:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cc', models.CharField(max_length=10, null=True, unique=True, verbose_name='Cédula')),
                ...
                ('gender', models.CharField(choices=[('male', 'Masculino'), ('female', 'Femenino'), ('other', 'Otro')], default='other', max_length=10, verbose_name='Sexo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subtotal', models.DecimalField(decimal_places=3, default=0.0, max_digits=9)),
                ('iva', models.DecimalField(decimal_places=3, default=0.0, max_digits=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pvp', models.DecimalField(decimal_places=3, default=0.0, max_digits=9, verbose_name='Precio de venta')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=3, default=0.0, max_digits=9)),
